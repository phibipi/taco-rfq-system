...
def generate_bulk_spk(template_file, nomor_surat, validity, load_type, df_filtered_origin, selected_vendors):
    ...
    for vendor in selected_vendors:
        ...
        try:
            ...
            create_docx_spk(template_file, nomor_surat, validity, load_type, vendor_name, contact_person, password_last5, origin_combined, alamat_combined, df_data, final_local_path)
            success_count += 1
...
# ==============================================================================
def create_docx_spk(template_file, nomor_surat, validity, load_type, vendor_name, contact_person, password_last5, origin_combined, alamat_combined, df_data, final_local_path):
    doc = DocxTemplate(template_file)
