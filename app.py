            ...
            if df_master.empty:
                ...
                with st.container(border=True):
                    ...
                    if not df_spk_global.empty:
                        # Hitung ranking kompetisi klasemen antar seluruh vendor (Klasemen Global murni tanpa dipotong angka 3!)
                        ...
                        # 🔒 KUNCI UTAMA 2: Hitung max prioritas asli di database saat itu tanpa intervensi angka 3 kuno! (Bisa 6, 7, 8, dst)
                        ...
                        # 🎯 STRATEGI SAKLEK: Saring global dulu berdasarkan batas prioritas pilihan admin, baru cari nama vendornya!
                            ...
                            if st.button("📄 Generate File SPK", type="primary", key="btn_execute_spk_gen"):
                                ...
                                with st.spinner(f"Mengunduh template {sel_pt_entitas} dari GitHub and memproses SPK..."):
                                    try:
                                        ...
                                        # Filename otomatis dinamis merepresentasikan saringan prioritas asli lo honey!
